...
namespace Dharma.Libraries.Lang
{
    public class IdentityMensagensPortugues : IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordRequiresNonAlphanumeric() { return new IdentityError { Code = nameof(PasswordRequiresNonAlphanumeric), Description = $"As senhas devem conter ao menos um caractere não alfanumérico" }; }
        ...
        public override IdentityError PasswordRequiresLower() { return new IdentityError { Code = nameof(PasswordRequiresLower), Description = $"As senhas devem conter ao menos um caractere em caixa baixa ('a'-'z')." }; }
        public override IdentityError PasswordRequiresUpper() { return new IdentityError { Code = nameof(PasswordRequiresUpper), Description = $"As senhas devem conter ao menos um caractere em caixa alta ('A'-'Z')." }; }
